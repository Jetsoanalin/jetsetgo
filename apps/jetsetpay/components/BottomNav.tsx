...
export default function BottomNav({ active = "pay" as "home" | "pay" | "me" }) {
  return (
    <nav className="fixed inset-x-0 bottom-3 z-[60] mx-auto w-[92%] rounded-full bg-neutral-900/95 border border-neutral-800 shadow-2xl backdrop-blur px-4 py-2 flex items-center justify-between">
